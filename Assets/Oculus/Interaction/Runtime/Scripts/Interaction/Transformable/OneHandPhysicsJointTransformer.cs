...
namespace Oculus.Interaction
{
    ...
    /// to the transformable. It also supports adding custom joints for grabbing
    /// to improve stability on some constrained grabs.
    /// </summary>
    public class OneHandPhysicsJointTransformer : MonoBehaviour, ITransformer
    {
        /// <summary>
        /// Optional. The custom joint to use when grabbing the transformable.
        /// Set this field to a Joint in an disabled gameObject, it will be duplicated every time
        /// a new Grabber grabs this object, and the anchoring will be adjusted automatically.
        /// If not set a FixedJoint will be used.
        /// If the transformable is already attached to something with a joint, using preprocessing here is not recommended.
        /// </summary>
        ...
        {
            GrabPoint grabPoint = _transformable.GrabPoints[0];
            _targetPosition = grabPoint.GrabPosition;
            _targetRotation = grabPoint.GrabRotation;
        ...
        /// <summary>
        /// Attaches the transformable to a rigidbody using a joint.
        /// It will use the desired joint configuration set in _customJoint or
        /// the default one.
        /// <paramref name="rigidbody">The rigidbody to be attached to this transformable using a joint</paramref>
        /// </summary>
        ...
        /// for connecting to transformable via joints.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new proxy RigidBody to anchor the transformables.
        /// </summary>
